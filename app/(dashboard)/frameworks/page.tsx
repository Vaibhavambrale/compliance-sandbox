              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody className="text-muted-foreground">
                    ...
                    <tr className="border-b">
                      <td className="py-2 pr-4"><Badge className="bg-orange-100 text-orange-700" variant="secondary">High</Badge></td>
                    ...
                    <tr className="border-b">
                      <td className="py-2 pr-4"><Badge className="bg-amber-100 text-amber-700" variant="secondary">Limited</Badge></td>
        ...
        <AccordionItem value="meity" className="border rounded-lg px-4">
          <AccordionTrigger className="hover:no-underline">
            <div className="flex items-center gap-3">
              ...
              <Badge className="bg-amber-100 text-amber-700" variant="secondary">Emerging (Advisory Only)</Badge>
            </div>
          </AccordionTrigger>
          <AccordionContent>
            <div className="space-y-4 pt-2">
